const TRANSACTION_LIST_FIELDS = [
  ...
  },
  {
    ...
    headerName: "介護サービス（情報）",
    width: 150,
    type: "checkbox",
    isDisplay: true,
  },
  {
    field: "koyou_workplace_environment_philosophy_consult",
    headerName: "理念・教育・環境等（相談）",
    width: 300,
    type: "checkbox",
    isDisplay: true,
  },
  {
    field: "koyou_workplace_environment_philosophy_inform",
    headerName: "理念・教育・環境等（情報）",
    width: 300,
    type: "checkbox",
    isDisplay: true,
  },
  {
    field: "koyou_workplace_environment_ict_consult",
    headerName: "生産性向上 ICT等（相談）",
    width: 300,
    type: "checkbox",
    isDisplay: true,
  },
  {
    field: "koyou_workplace_environment_ict_inform",
    headerName: "生産性向上 ICT等（情報）",
    width: 300,
    type: "checkbox",
    isDisplay: true,
  },
